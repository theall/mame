...
public:
	...
	template<class _Object> static devcb_base &set_int1_cb(device_t &device, _Object object) { return downcast<k053252_device &>(device).m_int1_cb.set_callback(object); }
	template<class _Object> static devcb_base &set_int2_cb(device_t &device, _Object object) { return downcast<k053252_device &>(device).m_int2_cb.set_callback(object); }
	template<class _Object> static devcb_base &set_vsync_cb(device_t &device, _Object object) { return downcast<k053252_device &>(device).m_vsync_cb.set_callback(object); }
	template<class _Object> static devcb_base &set_vblank_cb(device_t &device, _Object object) { return downcast<k053252_device &>(device).m_vblank_cb.set_callback(object); }
