...
protected:
	...
	static void generate_tile_layout(tile_layout *tl, int &tl_count, int minp, int maxp, int screen_center, int width_order, int zoom, const int *tile_id_steps, bool flip, bool mirror, bool gflip);
