...
private:
	...
	template<bool gflipx, bool gflipy> void draw_line_block(bitmap_ind16 *bitmap, int layer, uint32_t min_y, uint32_t max_y, uint32_t min_x, uint32_t max_x, uint32_t deltay, uint32_t deltax);
};
